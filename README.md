...
```toml
[dependencies]
sevenz-rust2 = { version = "0.9", features = ["aes256"] }
```
...
```toml
[dependencies]
sevenz-rust2 = { version = "0.9", features = ["compress"] }
```
...
```toml
[dependencies]
sevenz-rust2 = { version = "0.9", features = ["compress", "aes256"] }
```
